// front-door.bicep — Phase 6
// Azure Front Door (Standard/Premium), WAF policy, Private Link origin to APIM.
//
// See docs/03-Implementation-Guide.md Phase 6 for the full spec and Claude Code
