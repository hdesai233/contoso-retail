...
// Key Vault (Premium) with RBAC auth, soft-delete + purge protection, Private Endpoint, diagnostic settings.
//
// See docs/03-Implementation-Guide.md Phase 1 for the full spec and Claude Code
