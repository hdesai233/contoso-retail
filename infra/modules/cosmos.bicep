// cosmos.bicep — Phase 3
// Cosmos DB (NoSQL): database 'contoso-retail', containers products/reviews/chat-history, autoscale, PE, continuous backup.
//
// See docs/03-Implementation-Guide.md Phase 3 for the full spec and Claude Code
