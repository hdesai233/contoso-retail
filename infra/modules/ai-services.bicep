// ai-services.bicep — Phase 4
// Cognitive Services multi-service account (Language, Vision, Content Safety), PE.
//
// See docs/03-Implementation-Guide.md Phase 4 for the full spec and Claude Code
